...
namespace Facade
{
    //Надає єдиний інтерфейс до множини інших інтерфейсів у системі.Фасад визначає
    //верхній інтерфейс, що робить систему легшою до використання
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(facade.HaveRestWithOwnSkis());
